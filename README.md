# DemoOrg::CloudFront::BehaviorHook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `demoorg-cloudfront-behaviorhook.json`
2. Implement your resource handlers in `demoorg_cloudfront_behaviorhook/handlers.py`
